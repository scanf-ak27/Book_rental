...
#===BG Image===================
	login_menu.bg= PhotoImage(file="images/TheBookStore1.png")
	...
	#id
	id_label=Label(login_menu,relief=GROOVE,text="Your ID:",font=('arial',15,'bold'))
	id_label.grid(row=9,column= 5)
	id_input_login=Entry(login_menu)
	id_input_login.grid(row=9,column=6,columnspan=1,pady=20)
	
	#password
	password_label=Label(login_menu,relief=GROOVE,text="Password:",font=('arial',15,'bold'))
	password_label.grid(row=10,column= 5)
	password_input_login=Entry(login_menu, show="*")
	password_input_login.grid(row=10,column=6,columnspan=1,pady=20)
	
	#login button
	loginbutton1=Button(login_menu,command=login_check,text=" Login ",bg='light blue',height=2,width=14,font=k_font)
	loginbutton1.grid(row=11,column= 5, columnspan=1,pady= 2)
	
	#register button
	registerbutton=Button(login_menu,command=register_in,text=" Register ",bg='light blue',height=2,width=14,font=k_font)
	registerbutton.grid(row=11,column= 6,columnspan=1,pady=2)
	#feedback button
	# feedbackbutton=Button(login_menu,command=feedback_read,text=" Feedback ",bg='light blue',height=2,width=14,font=k_font)
	# feedbackbutton.grid(row=13,column = 5,columnspan=1,pady= 2)
	#admin button
	adminbutton=Button(login_menu,command=admin_in,text=" Admin Login ",bg='light blue',height=2,width=14,font=k_font)
	adminbutton.grid(row=13 ,column = 5,columnspan=1,pady= 2)
...
def register_in():
	...
	title2_label=Label(login_menu,relief=GROOVE,text="BOOK RENTAL SYSTEM REGISTRATION PORTAL",font=('Times new roman',20,'bold'))
	title2_label.grid(row=0,column=25,columnspan=2,pady=20)

	

	id_label=Label(register_menu,text="Your ID",font=('arial',20,'bold'))
	id_label.grid(row=9,column= 25,columnspan=1,pady=20)

	name_label=Label(register_menu,text="Full Name",font=('arial',20,'bold'))
	name_label.grid(row= 10,column=25,columnspan=1,pady=20)

	email_label=Label(register_menu,text="Email",font=('arial',20,'bold'))
	email_label.grid(row= 11,column=25,columnspan=1,pady=20)

	password_label=Label(register_menu,text="Password",font=('arial',20,'bold'))
	password_label.grid(row= 12,column=25,columnspan=1,pady=20)

	id_input=Entry(register_menu)
	id_input.grid(row=9,column=27,columnspan=1,pady=20)

	name_input=Entry(register_menu)
	name_input.grid(row=10,column=27,columnspan=1,pady=20)

	email_input=Entry(register_menu)
	email_input.grid(row=11,column=27,columnspan=1,pady=20)

	password_input=Entry(register_menu)
	password_input.grid(row=12,column=27,columnspan=1,pady=20)

	loginbutton1=Button(register_menu,command=login_in,text=" Login ",bg='light blue',height=2,width=14,font=k_font)
	loginbutton1.grid(row=13,column=25,columnspan=1,pady=20)
	registerbutton=Button(register_menu,command=register_check,text=" Register ",bg='light blue',height=2,width=14,font=k_font)
	registerbutton.grid(row=14,column=25,columnspan=1,pady=20)
...
def Admin_Opt():
		...
		addbutton=Button(opt_menu,command=add_book,text=" Add Book ",bg='light green',height=1,width=12,font=k_font)
		delbutton=Button(opt_menu,command=del_book,text=" Remove Book ",bg='light green',height=1,width=12,font=k_font)
...
def add_book():
	...
	book_id_label=Label(add_menu,text="Book ID (Should be of atleast length 5)")
	book_label=Label(add_menu,text="Book Name")
	author_label=Label(add_menu,text=" Name")
	publisher_label=Label(add_menu,text="Publisher")
	book_id=Entry(add_menu)
	book_name=Entry(add_menu)
	author_name=Entry(add_menu)
	publisher_name=Entry(add_menu)
	addbutton1=Button(add_menu,command=add_check,text=" Add Book ",bg='light yellow',height=1,width=10,font=k_font)
	...
	publisher_label.grid(row=3,sticky=E)
	publisher_name.grid(row=3,column=1)
...
def del_book():
	...
	borrow_list4=Listbox(del_menu,height=50,width=50)
	borrow_list5=Listbox(del_menu,height=50,width=20)

	for num in range(0,norecord):
		borrow_list.insert(0,Id[num])
		borrow_list2.insert(0,Title[num])
		borrow_list3.insert(0,Author[num])
		borrow_list4.insert(0,Publisher[num])
		borrow_list5.insert(0,Availability[num])


	b_label=Label(del_menu,text="Book ID")
	rb_id=Entry(del_menu)
	delbutton1=Button(del_menu,command=del_check,text=" Remove book ",bg='light green',height=1,width=10,font=k_font)
	borrow_list2.configure(background="light blue")
	borrow_list3.configure(background="light blue")
	borrow_list.configure(background="light blue")
	borrow_list4.configure(background="light blue")
	...
	borrow_label4=Label(del_menu,text="Publisher")
	borrow_label5=Label(del_menu,text="Availability")
	...
	borrow_label5.grid(row=6,column=9)
	...
	borrow_list5.grid(row=7,column=9)
...
def del_check():
	...
	if(pos == -1):
		tkinter.messagebox.showinfo("Delete","Book not present.Please re-enter")
		del_menu.destroy()
		return(del_book)
	else:
		f = open ('BData.txt', 'r')
...
def Main_Menu():
	...
	base.wm_title("BOOK RENTAL STORE")
	...
	#Bunch of labels
	status = Label(base,text=("Date and time logged in: " + current_time),bd=1,relief=SUNKEN,anchor=W,bg='black',fg="white")
	orionLabel=Label(base, text="BOOK RENTAL STORE",bg='black',font=("Gabriola", "50","bold","italic"),fg="white")
	welcomeLabel=Label(base,font=("Freestyle Script","30","bold"))
	...
	#Buttons
	borrow_but=Button(bottomFrame,bg="black",fg="white",text="Borrow your Book ",font=in_font,height=5,width=20,command=borrow_in)
	return_but=Button(bottomFrame,bg="black",fg="white",text="Return your Book ",font=in_font,height=5,width=15,command=return_in)
	search_but=Button(bottomFrame,bg="black",fg="white",text="Search for your Book",font=in_font,height=5,width=20,command=search_in)
	# feedback_but=Button(bottomFrame,bg="light green",text="give Feedback",font=in_font,height=5,width=15,command=feedback_in)
...
def borrow_in():
	...
	for num in range(0,norecord):
		...
		borrow_list3.insert(0,Publisher[num])
		borrow_list4.insert(0,Availability[num])

	borrow_list.configure(background="black",foreground="white")
	borrow_list1.configure(background="black",foreground="white")
	borrow_list2.configure(background="black",foreground="white")
	borrow_list3.configure(background="black",foreground="white")
	borrow_list4.configure(background="black",foreground="white")
	borrow_label1=Label(borrow_menu,font=("Times", "20","bold","italic"))
	borrow_label=Label(borrow_menu,text="Id")
	borrow_label2=Label(borrow_menu,text="Book")
	borrow_label3=Label(borrow_menu,text="Author")
	borrow_label4=Label(borrow_menu,text="Publisher")
	borrow_label5=Label(borrow_menu,text="Stocks")

	borrow_entry1=Entry(borrow_menu,width=50)
	borrow_button1=Button(borrow_menu,text="Borrow",command=borrow_check,font=("Times new roman","10","bold"),bg="black",foreground="white")
	...
	borrow_label5.grid(row=3,column=12)
	...
	borrow_list4.grid(row=4,column=12)
...
def borrow_check():
	...
	for l in f:
		...
		if l[0] ==  id:
			count += 1
	if count >= 2:
		tkinter.messagebox.showinfo("Borrow", "Cannot borrow more than 2 Books at a time")
		borrow_menu.destroy()
...
def return_in():
	...
	for num in range(0,norecord):
		...
		return_list3.insert(0,Publisher[num])
		return_list4.insert(0,Availability[num])

	return_list.configure(background="black",foreground="white")
	return_list1.configure(background="black",foreground="white")
	return_list2.configure(background="black",foreground="white")
	return_list3.configure(background="black",foreground="white")
	return_list4.configure(background="black",foreground="white")
	return_label=Label(return_menu,text="Id")
	return_label2=Label(return_menu,text="Book Name")
	return_label3=Label(return_menu,text="Author")
	return_label4=Label(return_menu,text="Publisher")
	return_label5=Label(return_menu,text="Stocks")

	return_button1=Button(return_menu,text="Return",command=return_check,font=("Times new roman","10","bold"),bg="black",fg="white")
	return_entry1=Entry(return_menu,width=50)
	return_label1=Label(return_menu,font=("Times", "12","bold","italic"))
	...
	return_label5.grid(row=3,column=10)
	...
	return_list4.grid(row=4,column=10)
...
def search_in():
	...
	search_label1=Label(search_menu,font=("Times", "12","bold","italic"))
	search_label1.pack(side=TOP)

	search_entry = Entry(search_menu,width=50)
	search_entry.pack(side=TOP)

	search_button=Button(search_menu,text="Search",command=search_check,font=("Times new roman","10","bold"),bg="black",fg="white")
